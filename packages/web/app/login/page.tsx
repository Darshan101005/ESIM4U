...
import { signIn, clearSessionCache, authClient } from "@/lib/auth-client";
...
export default function LoginPage() {
  ...
  const signInWithGoogle = async () => {
    ...
    try {
      // Redirects to Google, then back to /api/auth/callback/google and on to /dashboard.
      ...
      <div className={`absolute inset-0 flex items-center justify-center transition-all duration-1000 ease-out ${
        ...
        <div className="relative z-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 text-[14px] font-semibold text-[#1A1D20] active:scale-[0.99] disabled:opacity-60"
          >
          ...
          <p className="text-center text-[13px] text-[#6B7280] font-medium mt-5">
