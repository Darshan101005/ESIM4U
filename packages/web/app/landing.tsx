...
export default function Landing() {
  ...
  useEffect(() => {
    // Render the cached state instantly for returning users (avoids a
    // Login → Dashboard flip), then confirm against the server.
        ...
        <div className="w-full px-5 sm:px-8 md:px-12 xl:px-16 pt-5 sm:pt-8 flex items-center justify-between relative z-50">
          ...
          <div className="flex-1 flex justify-end">
            <div className={`flex items-center gap-3 transition-opacity duration-200 ${authChecked ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
              {authUser ? (
                <>
                  <Link href="/dashboard" className="px-6 py-2.5 rounded-full bg-white/80 backdrop-blur-sm border border-gray-100 text-[#FF561E] font-semibold text-[14px] hover:bg-white hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(255,86,30,0.15)] hover:border-orange-100 transition-all duration-300 shadow-sm">
                    Dashboard
                  </Link>
